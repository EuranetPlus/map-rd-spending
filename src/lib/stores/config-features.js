export const config = {
	mapTitle: 'map-rd-spending', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'map-rd-spending.vercel.app', // The url provided when deploying the map on Vercel
